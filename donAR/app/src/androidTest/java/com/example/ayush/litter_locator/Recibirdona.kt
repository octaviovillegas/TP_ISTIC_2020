...
import com.example.food_locator.AppDatabase
import com.example.food_locator.Datahelper
import com.example.food_locator.Datahelper.car.foodHuri
import com.example.food_locator.R
import com.example.food_locator.SucessActivity


class Recibirdona : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_recibirdona)
...
//create a list of items for the spinner.
        ...
        submit?.setOnClickListener({
            ...
            if(tran.picUri != null){
                ...
                dbfood.storeData(
                    Datahelper.car.foodHtype,
                    Datahelper.car.foodHinfo,
                    Datahelper.car.foodHloc,
                    Datahelper.car.foodHuri,
                    Datahelper.car.foodHname)
                //  Toast.makeText(this@Uploadfood,Datahelper.car.ttr,Toast.LENGTH_LONG).show()


                var mint:Intent ?= null
                mint= Intent(this@Recibirdona, SucessActivity::class.java)
                startActivity(mint)
            }else{
                Toast.makeText(this@Recibirdona,"Suba la imagen",Toast.LENGTH_SHORT).show()
            }
        })
        ...
        Intent(MediaStore.ACTION_IMAGE_CAPTURE).also { takePictureIntent ->
            ...
            takePictureIntent.resolveActivity(packageManager)?.also {
                ...
                val photoFile: File? = try {
                    ...
                    Toast.makeText(this@Recibirdona, "El problema está aquí", Toast.LENGTH_SHORT).show()
                    this.finish()
                    null
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, InUri: Intent?) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (cameraUri != null){
                ...
                Toast.makeText(this@Recibirdona,"Imagen Subida Correctamente", Toast.LENGTH_SHORT).show()
                mLocation?.visibility = View.VISIBLE
                submit?.visibility = View.VISIBLE
                addPhoto?.visibility = View.VISIBLE
                addPhotoimg?.visibility = View.INVISIBLE
        ...
        if(requestCode == GALLERY){
            if (InUri != null) {
                ...
                try {
                    ...
                    e.printStackTrace()
                    Toast.makeText(this@Recibirdona, "Intento fallido!", Toast.LENGTH_SHORT).show()
                }
